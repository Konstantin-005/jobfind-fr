...
import { getMyResumes } from '@/app/utils/api';
  ...
  return (
    <div className="max-w-6xl mx-auto pt-12 pb-8 px-4">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/user/resume/add" className="flex items-center gap-2 bg-blue-50 text-blue-700 border border-blue-200 px-5 py-2 rounded-lg font-semibold text-base shadow hover:bg-blue-100 transition">
        ...
        <div className="divide-y divide-gray-200 space-y-6">
          {resumes.map((resume) => (
            <div className="py-8 px-8 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow" key={resume.resume_id}>
              <div className="mb-3">
                <Link href={`/user/resume/${resume.resume_id}`}>
              ...
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <Link href={`/user/resume/${resume.resume_id}`} className="text-blue-600 hover:underline font-medium">Редактировать</Link>
