...
export const API_ENDPOINTS = {
  ...
  dictionaries: {
    ...
    companies: `${API_BASE_URL}/api/dictionaries/companies`,
    companyById: (companyId: number) => `${API_BASE_URL}/api/dictionaries/companies/${companyId}`,
  ...
  resumes: {
    ...
    contactsByLink: (linkUuid: string) => `${API_BASE_URL}/api/resumes/link/${linkUuid}/contacts`,
