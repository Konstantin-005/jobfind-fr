...
export default function ResumeSearchPage() {
  ...
  // Build URLSearchParams from state/filters
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {['Регион', 'Статус поиска', 'Тип занятости', 'График работы', 'Общий опыт', 'Уровень дохода'].map((filter) => (
            <button key={filter} className="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium transition-colors flex items-center gap-1">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg className={`w-4 h-4 text-gray-400 transition-transform ${isSortOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              ...
              >
                ...
                <svg className={`w-4 h-4 text-gray-400 transition-transform ${isLimitOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
        ...
        <div className="space-y-4">
          {isLoading && resumes.length === 0 ? (
            ...
            resumes.map((resume) => (
              <ResumeCard key={resume.link_uuid} resume={resume} />
            ))
          ) : (
