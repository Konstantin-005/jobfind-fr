            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 flex-1">
                ...
                {(status === 'success' || status === 'error') && message && (
                  <div className={`mt-6 rounded-md p-4 ${status === 'success' ? 'bg-green-50' : 'bg-red-50'}`}>
                ...
                <div className="mt-6 flex flex-col gap-3">
                  ...
                  >
                    {cooldownSeconds > 0 ? `Отправить ещё раз (${cooldownSeconds}с)` : (status === 'loading' ? 'Отправляем...' : 'Отправить письмо ещё раз')}
                  </button>
                ...
                {showChangeEmail && (
                  <div className="mt-4 rounded-md border border-gray-200 p-4">
                    ...
                    >
                      {cooldownSeconds > 0 ? `Подождите ${cooldownSeconds}с` : (status === 'loading' ? 'Отправляем...' : 'Сохранить и отправить письмо')}
                    </button>
                  </div>
                )}
              </div>
