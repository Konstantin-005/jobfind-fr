...
/vakansii/[slug]/[professionSlug] - Список вакансий по городу и профессии (SSR)
...
4. Результаты отображаются в виде списка с пагинацией
   ...
   - Страница `/vakansii/[slug]/[professionSlug]` (SSR) использует серверную пагинацию (`page`, `limit`) и эндпоинт `GET /api/jobs/searchBySlug2?city_slug=...&profession_slug=...` для поиска вакансий строго по городу и профессии.
