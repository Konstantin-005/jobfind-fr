...
1. Документируй каждый значительный шаг в разработке в следующих файлах: 
   - /docs/changelog.md - хронологический журнал всех изменений (не пиши описание результатов, только сами сделанные изменения)
...
2. Формат записи в changelog.md: 
   ...
   - Описание исправлений
    ```
3.    в /docs/plan.md - вноси статус выполнения только крупных задач с описанием
Формат записи в /docs/plan.md : 
...
## Процесс разработки
 ...
 1. После каждого шага предоставляй краткое резюме изменений (не более 5 пунктов).
 ...
 6. Следуй архитектурным решениям и стандартам, описанным в /docs/architecture.md и /docs/requiements.md
...
1. При создании нового файла добавляй в его начало: 
    ...
    */
   ```
2. После реализации нового функционала актуализируй /docs/architecture.md
    включая: 
